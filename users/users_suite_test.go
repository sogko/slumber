...
func defineFactories() {
	gory.Define("adminAPIUser", domain.User{}, func(factory gory.Factory) {
		...
		factory["Roles"] = domain.Roles{domain.RoleAdmin}
	})
	gory.Define("inactiveAdminAPIUser", domain.User{}, func(factory gory.Factory) {
		factory["ID"] = gory.Sequence(func(n int) interface{} {
			return bson.NewObjectId()
		})
		factory["Username"] = gory.Sequence(func(n int) interface{} {
		...
		factory["Status"] = domain.StatusSuspended
		factory["LastModifiedDate"] = time.Now()
		factory["CreatedDate"] = time.Now()
		factory["Roles"] = domain.Roles{domain.RoleAdmin}
	})
	...
	gory.Define("newUser", domain.NewUser{}, func(factory gory.Factory) {
		factory["Username"] = gory.Sequence(func(n int) interface{} {
			return fmt.Sprintf("johndoe%d", n)
		})
		factory["Email"] = gory.Sequence(func(n int) interface{} {
	...
	gory.Define("newUserInvalidEmail", domain.NewUser{}, func(factory gory.Factory) {
		factory["Username"] = gory.Sequence(func(n int) interface{} {
			return fmt.Sprintf("johndoe%d", n)
		})
		factory["Email"] = gory.Sequence(func(n int) interface{} {
	...
	gory.Define("userUnconfirmed", domain.User{}, func(factory gory.Factory) {
		factory["ID"] = gory.Sequence(func(n int) interface{} {
			return bson.NewObjectId()
		})
		factory["Username"] = gory.Sequence(func(n int) interface{} {
		...
		factory["Status"] = domain.StatusPending
		factory["LastModifiedDate"] = time.Now()
		factory["CreatedDate"] = time.Now()
	})
}
